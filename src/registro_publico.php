  ...
  <div class="box">
    ...
    <?php else: ?>
      ...
      <div id="formBox" class="show">
        ...
        <input type="text" id="f-name" placeholder="Ej: Nombre apellido" autocomplete="name">

        <label for="f-dni">Últimos 3 números de tu DNI</label>
        <input type="text" id="f-dni" placeholder="Ej: 123" inputmode="numeric" maxlength="3" autocomplete="off">
